...
////ur10
//double d1=0.1273; double d4=0.163941; double d5=0.1157; double d6=0.0922; double a2=-0.612; double a3=-0.5723;
...
//  myfile1.open("error_Realtime.txt");
//  myfile2.open("cost_Realtime.txt");
//  myfile3.open("ControlVel1_Realtime.txt");
//  myfile4.open("ControlVel2_Realtime.txt");
//  myfile5.open("ControlVel3_Realtime.txt");
//  myfile6.open("ControlVel4_Realtime.txt");
//  myfile7.open("ControlVel5_Realtime.txt");
//  myfile8.open("ControlVel6_Realtime.txt");

//  myfile9.open("JointAngles1_Realtime.txt");
//  myfile10.open("JointAngles2_Realtime.txt");
//  myfile11.open("JointAngles3_Realtime.txt");
//  myfile12.open("JointAngles4_Realtime.txt");
//  myfile13.open("JointAngles5_Realtime.txt");
//  myfile14.open("JointAngles6_Realtime.txt");

//  myfile15.open("Weight1_Realtime.txt");
//  myfile16.open("Weight2_Realtime.txt");
//  myfile17.open("Weight3_Realtime.txt");
//  myfile18.open("Weight4_Realtime.txt");
...
//  double u[8],ud[8],s[8],sd[8];

//  double z,z_dot,z_prev,z_d,z_d_prev;
...
//    //                  std::cout << "Two: " << roll << "," << pitch << "," << yaw << std::endl;
...
//    //                                    cout<<"JP WRT baselink: "<<r2bl_mat*Jp1<<endl;
//    Jp=r2bl_mat*Jp1;
...
//    //              S_pose[0]=(Zeta.at<double>(0,0)+Zeta.at<double>(9,0))*px+u_ref;
//    //              S_pose[1]=(Zeta.at<double>(1,0)+Zeta.at<double>(10,0))*py+v_ref;
//    //              S_pose[2]=(Zeta.at<double>(2,0)+Zeta.at<double>(11,0))*px+u_ref;
//    //              S_pose[3]=(Zeta.at<double>(3,0)+Zeta.at<double>(12,0))*py+v_ref;
//    //              S_pose[4]=(Zeta.at<double>(4,0)+Zeta.at<double>(13,0))*px+u_ref;
//    //              S_pose[5]=(Zeta.at<double>(5,0)+Zeta.at<double>(14,0))*py+v_ref;
//    //              S_pose[6]=(Zeta.at<double>(6,0)+Zeta.at<double>(15,0))*px+u_ref;
//    //              S_pose[7]=(Zeta.at<double>(7,0)+Zeta.at<double>(16,0))*py+v_ref;
