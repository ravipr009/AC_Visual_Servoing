...
//cout<<"Jp wrt base: "<<Jp1<<endl;
   ...
   point_wrt_kinect.point.x = current_point_cloud->at(white_x2, white_y2).x;
    point_wrt_kinect.point.y = current_point_cloud->at(white_x2, white_y2).y;
...
//del_theta=-0.03*J_total_pinv*err;
del_theta=-0.07*J_total_pinv*err;
//del_theta=-0.1*J_total_pinv*err;
